...
import com.juliano.pessoas.exceptions.models.CamposErros;
import com.juliano.pessoas.exceptions.models.DetalhesExcecao;
import com.juliano.pessoas.exceptions.models.ErrorResponseDto;
...
public class ExcpetionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.juliano.pessoas.exceptions.NotFoundException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleEntityNotFound(com.juliano.pessoas.exceptions.NotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.juliano.pessoas.exceptions.NoContentRuntimeException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleNoContentRuntimeException(com.juliano.pessoas.exceptions.NoContentRuntimeException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.juliano.pessoas.exceptions.UnauthorizedException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleUnauthorizedException(com.juliano.pessoas.exceptions.UnauthorizedException ex, HttpServletRequest request) {
