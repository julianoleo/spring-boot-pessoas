package com.juliano.gerfin.exceptions;

import com.juliano.gerfin.exceptions.models.CamposErros;
import com.juliano.gerfin.exceptions.models.DetalhesExcecao;
...
public class ExcpetionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.juliano.gerfin.exceptions.NotFoundException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleEntityNotFound(com.juliano.gerfin.exceptions.NotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.juliano.gerfin.exceptions.NoContentRuntimeException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleNoContentRuntimeException(com.juliano.gerfin.exceptions.NoContentRuntimeException ex, HttpServletRequest request) {
