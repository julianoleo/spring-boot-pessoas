...
import com.juliano.apipessoas.exceptions.models.CamposErros;
import com.juliano.apipessoas.exceptions.models.DetalhesExcecao;
import com.juliano.apipessoas.exceptions.models.ErrorResponseDto;
...
public class ExcpetionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(com.juliano.apipessoas.exceptions.NotFoundException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleEntityNotFound(com.juliano.apipessoas.exceptions.NotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.juliano.apipessoas.exceptions.NoContentRuntimeException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleNoContentRuntimeException(com.juliano.apipessoas.exceptions.NoContentRuntimeException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(com.juliano.apipessoas.exceptions.UnauthorizedException.class)
    protected ResponseEntity<List<ErrorResponseDto>> handleUnauthorizedException(com.juliano.apipessoas.exceptions.UnauthorizedException ex, HttpServletRequest request) {
